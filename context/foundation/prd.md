...
Celem produktu jest funkcja ostrzegawcza, która uprzedza o niekorzystnych warunkach pogodowych na trasie.
...
## Open Questions
~~1. Jaki dokładnie próg jakości oznacza „brak/mylnych alertów powyżej progu”?~~ → ≤10% mylnych alertów
~~2. Czy sugestia objazdu lub zmiany godziny jest obowiązkowa w MVP?~~ → nie, MVP tylko pokazuje zagrożony odcinek i powiadamia
~~3. Czy model logowania imię + nick ma mieć dodatkową weryfikację?~~ → zmienione na email + hasło
